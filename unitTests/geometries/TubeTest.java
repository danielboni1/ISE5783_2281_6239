...
class TubeTest {
    ...
    public void testFindIntersections() {
        ...
        if (result.get(0).getX() > result.get(1).getX())
            result = List.of(result.get(1), result.get(0));
        P1 = new Point(value1, value1, 2 + value1);
        P2 = new Point(value2, value2, 2 + value2);
        assertEquals(List.of(P1, P2), result, "Bad intersections");
        ...
        if (result.get(0).getX() > result.get(1).getX())
            result = List.of(result.get(1), result.get(0));
        P1 = new Point(value1, value1, value1);
        P2 = new Point(value2, value2, value2);
        assertEquals(List.of(P1, P2), result, "Bad intersections");
        ...
        assertNotNull(result, "must be intersections");
        assertEquals(1, result.size(), "must be 1 intersections");
        P1 = new Point(value2, value2, 2 + value2);
        assertEquals(List.of(P1), result, "Bad intersections");
        ...
        assertNotNull(result, "must be intersections");
        assertEquals(1, result.size(), "must be 1 intersections");
        P1 = new Point(value2, value2, value2);
        assertEquals(List.of(P1), result, "Bad intersections");
        ...
        result = tube2.findIntersections(ray);
        assertNull(result, "Bad intersections");
        // TC79: Ray's begins at the surface and goes outside and the line crosses the
        // axis
