...
public class LightsTests {
    ...
    public void trianglesMultiLight() {
        ...
        scene2.geometries.add(geometries);
        scene2.setLights(List.of(
                new SpotLight(
                        new Color(0, 500, 0),
                        new Point(30, 10, -100),
                        new Vector(-2, -2, -2)),
                new PointLight(
                        new Color(500, 0, 0),
                        new Point(300, 100, 0)),
                new DirectionalLight(new Color(0, 0, 500), new Vector(-2, -2, -2)))
        );
    ...
    public void sphereMultiLight() {
        scene1.geometries.add(new Geometries(sphere));
        scene1.setLights(
                List.of(
                        new SpotLight(new Color(500, 0, 0),
                                new Point(40, 0, 10),
                                new Vector(0, 0, -1)),
                        new PointLight(
                                new Color(0,500,0),
                                new Point(200,200,-50)),
                        new DirectionalLight(new Color(70,40,150),new Vector( 10,10,-10))));//
    ...
    public void MoveCameraTest() {
        ...
        ImageWriter imageWriter = new ImageWriter("MoveCamera", 500, 500);
        camera1.moveTo(450)
                .moveUp(250)
                .moveRight(50)
                .turnUp(-22.5)
